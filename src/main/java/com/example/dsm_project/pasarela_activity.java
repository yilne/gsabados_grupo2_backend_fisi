...
public class pasarela_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       btnCerrar.setOnClickListener(view -> startActivity(new Intent(pasarela_activity.this, MainActivity.class)));
